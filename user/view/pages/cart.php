...
<div class="cart-container" style="padding: 30px; min-height: 500px; width: 900px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
    ...
    <?php if (!$isLoggedIn): ?>
        ...
        <div style="text-align: center; padding: 60px;">
            <img src="<?= BASE_URL ?>user/asset/img/shopping-cart.jpg" alt="Giỏ hàng trống" style="width: 120px; opacity: 0.6; margin-bottom: 20px;">
            <h3 style="color: #555;">Chưa có sản phẩm nào!</h3>
            <p style="margin: 10px 0;">Hãy đăng nhập để thêm sản phẩm vào giỏ hàng.</p>
            <button onclick="window.location.href='<?= BASE_URL ?>user/view/pages/login.php'" 
    ...
    <?php else: ?>
        ...
        <div style="text-align: center; margin-top: 30px;">
            <button onclick="window.location.href='<?= BASE_URL ?>user/view/pages/checkout.php'" 
