<?php
if (!defined('BASE_URL')) {
    define('BASE_URL', '/OODA/'); // sửa đúng tên folder gốc của bạn
}
include __DIR__ . '/../layout/header.php';
?>
<link rel="stylesheet" href="<?= BASE_URL ?>user/asset/styles/news.css">
  <div class="container">
            ...
            <div class="news-grid">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?= BASE_URL ?>user/asset/img/trai-cherry-Uc.jpg" alt="Cherry Úc">
                    </div>
                ...
                <div class="news-card">
                    <div class="news-image">
                     <img src="<?= BASE_URL ?>user/asset/img/trai-tao.jpg" alt="Táo Envy">
                    </div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?= BASE_URL ?>user/asset/img/trai-nho-My.jpg" alt="Nho Mỹ">
                    </div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?= BASE_URL ?>user/asset/img/leTrungQuoc.jpg" alt="Lê Trung Quốc">
                    </div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?= BASE_URL ?>user/asset/img/trai-kiwi.jpg" alt="Kiwi vàng">
                    </div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?= BASE_URL ?>user/asset/img/dua-mini-ThaiLan.jpg" alt="Dứa mini Thái Lan">
                    </div>
                    <div class="news-content">
