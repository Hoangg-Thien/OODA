...
if (!isset($_SESSION['user_name'])) {
    ...
    header("Location: searchProducts-nologin.php");
    exit();
}
?>
<!DOCTYPE html>  
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<div class='fruit-background'>
                ...
                <div class='icons'>
                <a href='product-details.php?id={$productId}' class='info-icon' title='Xem thông tin chi tiết'>
                <i class='fa-solid fa-circle-info fa-lg'></i>
                </a>
                <button class='add-to-cart' data-id='{$productId}' data-name='{$productName}' data-price='{$row['product_price']}'>
