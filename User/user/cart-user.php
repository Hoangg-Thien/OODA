...
if (!isset($_SESSION['user_name'])) {
    ...
    header("Location: cartusernologin.php");
    exit();
}
$cart = $_SESSION['cart'] ?? [];
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            <?php if (!empty($cart)): ?>
                ...
                <a href="product-details.php?id=<?= $id ?>" class="info-icon" title="Xem thông tin chi tiết">
                    <i class="fa-solid fa-circle-info fa-lg"></i>
                        ...
                        <td style="padding: 12px; border: 1px solid #ddd; text-align: center;">
                            <button onclick="if(confirm('Bạn có chắc muốn xóa sản phẩm này không?')) updateCart('remove', '<?= $id ?>')" style="color: red; border: none; background: transparent; cursor: pointer;">X</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
