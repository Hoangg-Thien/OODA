    ...
    <div >
        ...
        <?php
           ...
           // Tổng số sản phẩm với điều kiện lọc
            $totalQuery = "SELECT COUNT(*) AS total FROM sanpham WHERE product_type = 'Trái cây Ngon'";
            ...
            $sql = "SELECT * FROM sanpham WHERE product_type = 'Trái cây Ngon' LIMIT $start, $limit";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="fruit-background">
                        ...
                        <div class="icons">
                            <a href="product-details-nolog.php?id=' . $row['product_id'] . '" class="info-icon" title="Xem thông tin chi tiết">
