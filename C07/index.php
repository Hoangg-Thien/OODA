...
$_SESSION['cart'] = []; // tạo giỏ hàng rỗng cho tài khoản mới
...
<!DOCTYPE html>  
    ...
    <head>  
        ...
        <link rel="stylesheet" href="./User/styles/index.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>

        <link rel="shortcut icon" href="./User/img/favicon.png" type="image/x-icon"> 
...
.modal.show {
    ...
    <body>  
        <header>  
            <a href="#" class="fruit">  
                <img src="./User/img/carrotheader.png" alt="Cà rốt" />  
                Cà rốt  
            </a>  
            <a href="#" class="fruit">  
                <img src="./User/img/potatoheader.png" alt="Khoai tây" />  
                Khoai tây  
            </a>  
            <a href="#" class="fruit">  
                <img src="./User/img/watermelonheader.png" alt="Dưa hấu" />  
                Dưa hấu  
            </a>  
            <a href="#" class="fruit">  
                <img src="./User/img/orangeheader.png" alt="Trái cam" />  
                Cam  
            </a>  
            <a href="#" class="fruit">  
                <img src="./User/img/duagangheader.png" alt="Đu đủ" />  
                Đu đủ  
            </a>  
            <a href="#" class="fruit">  
                <img src="./User/img/tomatoheader.png" alt="Cà chua" />  
                Cà chua  
            </a>  
        </header>  
        ...
        <div class="sea-fruit-container" >  
            ...
            <div style="display: flex; align-items: center; padding: 10px 20px;">  
                <div class="product-category">DANH MỤC SẢN PHẨM
                    <ul>
                        <li><a href="./User/user/declious-fruits-nologin.php">Trái cây ngon </a></li>
                        <li><a href="./User/user/VietNamese-fruits-nolog.php">Trái cây Việt  </a></li>
                        <li><a href="./User/user/Imported-fruits-nologin.php">Trái cây Nhập Khẩu </a></li>
                    </ul>
                </div>  
                <div class="menu">  
                    <a href="./index.php" class="active">Trang chủ</a>  
                    <a href="./User/user/introduce.php">Giới thiệu</a>  
                    <a href="./User/user/news.php">Tin tức</a>  
                    <a href="./User/user/contact.php">Liên hệ</a> 
                    <a href="./User/user/cartusernologin.php" target="_blank" class="cart-icon" title="Go to Cart">
                        <i class="fas fa-shopping-cart"></i>
                        <span id="cart-count" style="margin-left: 5px; font-weight: bold;">0</span>
                    </a>
                </div>  
                <div class="search-container">
                <form action="./User/user/searchProducts-nologin.php" method="GET">
                <!-- Tìm kiếm đơn giản -->
                <div>
                ...
                <form action="./User/user/toggleSearch-nologin.php" method="GET">
...
<div class="dropdown ms-3" style="font-size: 1.1rem;">
    ...
    <ul class="dropdown-menu" aria-labelledby="guestDropdown">
        <li><a class="dropdown-item" href="./User/user/login-user.php" target="_blank">Đăng nhập</a></li>
        <li><a class="dropdown-item" href="./User/user/regis.php" target="_blank">Đăng ký</a></li>
    </ul>
</div>
        ...
        <div style="max-width: 100%; overflow: hidden; margin: auto;  margin-top: -190px;">  
            <img src="./User/img/salefruit.jpg" alt="salefruit" style="width: 100% ; height: 600px; display: block;">  
        </div>  
...
// Tổng số sản phẩm
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div class="fruit-background">
                        ...
                        <div class="icons">
                            <a href="./User/user/product-details-nolog.php?id=' . $row['product_id'] . '" class="info-icon" title="Xem thông tin chi tiết">
        ...
        <div style="max-width: 100%; overflow: hidden; margin: auto;  margin-top: 100px;">  
            <img src="./User/img/banner-quang-cao.jpg" alt="banner-quang-cao" style="width: 100%; display: block;">  
        </div>
        
        <div class="policy-container" >
            <div >
                <img src="./User/img/policy1.png" alt="policy1">
            ...
            <div>
                <img src="./User/img/policy2.png" alt="policy2">
            ...
            <div>
                <img src="./User/img/policy3.jpg" alt="policy3">
            ...
            <div >
                <img src="./User/img/policy4.png" alt="policy2">
        ...
        <div class="logo" style="color:#444444;padding-bottom:30px ; height: 150px;">
             <img src="./User/img/seafruits-logo.png" alt="seafruits-logo">
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul>
                    ...
                    <li><a href="./User/user/introduce.php">Giới thiệu</a></li>
                    <li><a href="./User/user/news.php">Tin tức</a></li>
                    <li><a href="./User/user/contact.php">Liên hệ</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h3>Dịch vụ</h3>
...
const input = document.getElementById("searchInput");
    ...
    input.addEventListener("keyup", function () {
        ...
        if (query.length > 0) {
            fetch(`./User/user/suggest.php?term=${encodeURIComponent(query)}`)
    ...
    function confirmAddToCart(productId) {
        if (confirm("Bạn cần đăng nhập để thêm sản phẩm vào giỏ hàng. Bạn có muốn đăng nhập không?" )) {
            window.location.href = "./User/user/login-user.php";
        } else {
